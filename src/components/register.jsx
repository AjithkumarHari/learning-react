                ...
                <div class="relative z-10 flex w-96 flex-col rounded-lg border bg-white px-5 py-10 shadow-xl sm:mx-auto">
                    ...
                    <div>
                        <div class="relative mt-2 w-full pb-5">
                            ...
                            })} type="password" maxLength={9} id="password" class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pt-4 pb-2.5 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    ...
                    <div class="flex w-full justify-center items-center pt-3">
                        <button class="shrink-0 inline-block w-36 rounded-lg bg-blue-600 py-3 font-bold text-white" >Register</button>
                    </div>
